"""ConferenceMember repository implementation using SQLAlchemy ORM."""
...
from src.infrastructure.persistence.sqlalchemy_models import ConferenceMemberModel


class ConferenceMemberRepositoryImpl(
    BaseRepositoryImpl[ConferenceMember], IConferenceMemberRepository
):
    """Implementation of ConferenceMemberRepository using SQLAlchemy ORM."""
