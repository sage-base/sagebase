    ...
    with st.form(f"conference_edit_form_{conference_id}"):
        ...
        with col1:
            election_cycle_years = st.number_input(
                ...
                key=f"edit_election_cycle_years_{conference_id}",
            )
        with col2:
            base_election_year = st.number_input(
                ...
                key=f"edit_base_election_year_{conference_id}",
            )
        with col3:
            term_number_at_base = st.number_input(
                ...
                key=f"edit_term_number_at_base_{conference_id}",
            )
        ...
        use_election_cycle = st.checkbox(
            ...
            key=f"edit_use_election_cycle_{conference_id}",
        )
