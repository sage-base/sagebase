...
class TestPolitician:
    ...
    def test_str_representation(self) -> None:
        ...
        politician = Politician(
            name="佐藤一郎", prefecture="東京都", district="東京1区"
        )
        assert str(politician) == "佐藤一郎"

        politician_with_id = Politician(
            id=42, name="鈴木二郎", prefecture="大阪府", district="大阪1区"
        )
    ...
    def test_various_districts(self) -> None:
        ...
        for district in districts:
            politician = Politician(
                name="Test Politician", prefecture="東京都", district=district
            )
    ...
    def test_furigana_variations(self) -> None:
        ...
        for name, furigana in test_cases:
            politician = Politician(
                name=name, prefecture="東京都", district="東京1区", furigana=furigana
            )
    ...
    def test_inheritance_from_base_entity(self) -> None:
        ...
        # Create without id
        politician_no_id = Politician(
            name="Test Politician", prefecture="東京都", district="東京1区"
        )
    ...
    def test_edge_cases(self) -> None:
        ...
        # Very long names
        long_name = "山" * 50
        politician_long = Politician(
            name=long_name, prefecture="東京都", district="東京1区"
        )
        ...
        politician_special = Politician(
            name=special_name, prefecture="東京都", district="東京1区"
        )
        ...
        politician_long_url = Politician(
            name="Test",
            prefecture="東京都",
            district="東京1区",
            profile_page_url=long_url,
        )
    ...
    def test_id_assignment(self) -> None:
        ...
        # Without ID
        politician1 = Politician(name="Test 1", prefecture="東京都", district="東京1区")
        assert politician1.id is None

        # With ID
        politician2 = Politician(
            name="Test 2", prefecture="東京都", district="東京1区", id=100
        )
